 ...
 */
public class PreSplitFoldRunTestLinearPerceptronHighVsLow {
    ...
    private Supplier<Model> lpFactory(ArrayList<String> sortedLabels) {
        ...
        return () -> {
            ...
            for (int i = 0; i < k - 1; i++) models.add(new LinearPerceptronModel());
    ...
    @Test
    public void testLinearPerceptronHighVsLow() throws DiscreteFeaturesNotAllowed {
        Job[] jobs = {
        ...
        for (Job job : jobs) {
            ...
            for (String cond : conditions) {
                ...
                if (dp != null && dp.getConfusionMatrix() != null) {
                    ...
                    System.out.println("=== " + name + "HvL - LinearPerceptron");
        ...
        excel.writeToExcel("Results_LP_HvL_LeakageFree_PerFold.xlsx");
        System.out.println(">>> Written: Results_LP_HvL_LeakageFree_PerFold.xlsx");
    }
}
