 ...
 */
public class PreSplitFoldRunTestLinearPerceptronOneVsRest {
    ...
    private Supplier<Model> lpFactory(ArrayList<String> sortedLabels) {
        ...
        return () -> {
            ...
            for (int i = 0; i < k; i++) models.add(new LinearPerceptronModel());
    ...
    @Test
    public void testLinearPerceptronOneVsRest() throws DiscreteFeaturesNotAllowed {
        Job[] jobs = {
        ...
        for (Job job : jobs) {
            ...
            for (String cond : conditions) {
                ...
                if (dp != null && dp.getConfusionMatrix() != null) {
                    ...
                    System.out.println("=== " + name + "OvR - LinearPerceptron");
        ...
        excel.writeToExcel("Results_LP_OvR_LeakageFree_PerFold.xlsx");
        System.out.println(">>> Written: Results_LP_OvR_LeakageFree_PerFold.xlsx");
    }
}
